...
-- NanoBio / Supabase canonical database structure
-- Generated by splitting the canonical config.sql.
--
-- Contains database structure only: schemas, domains, tables, indexes,
-- constraints, functions/RPCs, triggers, views, RLS policies, grants/revokes,
-- storage policies and structural migration guards.
--
-- IMPORTANT: destructive LOCAL/SANDBOX rebuild script.
-- Run this file FIRST, then run 02, 03, 04 and 05 in order.
-- =============================================================================
...
-- same final M13 contract as the numbered local/sandbox rebuild bundle.
