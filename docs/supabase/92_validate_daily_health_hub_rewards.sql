-- Static/sandbox validation for 03_schema_daily_health_hub_rewards.sql.
-- Run after 01 through 06 in a disposable Supabase sandbox.
...
-- - 01_schema_rebuild_local_sandbox.sql JPEG proof constraints remain unchanged.
