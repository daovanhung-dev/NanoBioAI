...
-- Apply AFTER 01_schema_rebuild_local_sandbox.sql on a disposable sandbox.
...
-- ---------------------------------------------------------------------------
-- 01_schema_rebuild_local_sandbox.sql intentionally treats
...
begin
  ...
  -- snapshots from 01_schema_rebuild_local_sandbox.sql; only completion state
  -- is changed here.
  with latest as (
