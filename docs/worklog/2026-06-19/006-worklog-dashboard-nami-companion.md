...
# Worklog - Dashboard Nami Companion
...
- Refactor Nami chat FAB thành `DraggableAIChatButton`; menu shell chỉ hiện nút chat ở Dashboard tab, route `/dashboard` vẫn có nút standalone.
