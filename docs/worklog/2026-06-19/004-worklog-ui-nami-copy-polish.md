Commit đề xuất: fix(ui): thổi hồn Nami cho copy và trạng thái UI

# Worklog - Nami hóa copy UI
...
- Chỉnh primitive `ErrorState` để mặc định dùng tiếng Việt và giọng Nami hơn.
