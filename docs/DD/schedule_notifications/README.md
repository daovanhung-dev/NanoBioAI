...
- DASHBOARD_SCHEDULE: update completion events and manual tasks.
...
## Validation Notes
- Existing generated notification behavior remains unchanged.
- New reminder opt-out is covered by a focused notification test.
- Real-device notification delivery still requires device smoke evidence before production release.
