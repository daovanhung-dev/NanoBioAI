...
|---|---|---|---|---|---|---|---|---|---|
| AI_CHAT-FN01 | openAiChatWithEntitlement | AI_CHAT-F01 | Use case / Service | planned:lib/app_versions/v2/features/ai_chat/application/ai_chat_fn01.dart | Mở AI Chat | Command + actor context | Result/Error | Audit/event when required | Draft |
| AI_CHAT-FN02 | sendAiChatQuestion | AI_CHAT-F02 | Use case / Service | planned:lib/app_versions/v2/features/ai_chat/application/ai_chat_fn02.dart | Submit chat question | Command + actor context | Result/Error | Audit/event when required | Draft |
...
- [ ] Happy path cho AI_CHAT-FN01.
- [ ] Business rule violation cho AI_CHAT-BR01.
...
- [ ] Happy path cho AI_CHAT-FN02.
- [ ] Business rule violation cho AI_CHAT-BR02.
- [ ] Permission denied theo role/scope.
- [ ] Idempotency/retry nếu có ghi dữ liệu.
- [ ] Audit hoặc event được tạo khi BD yêu cầu.
