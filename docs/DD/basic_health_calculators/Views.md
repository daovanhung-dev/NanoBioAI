...
|---|---|---|---|---|---|---|---|---|
| BASIC_HEALTH_CALC-V01 | Basic calculator | planned route/action for basic_health_calculators | Guest, Member | BASIC_HEALTH_CALC-F01 | Page / Flow / Admin view | BASIC_HEALTH_CALC-API01 | Draft | assets/README.md |
| BASIC_HEALTH_CALC-V02 | Formula config view | planned route/action for basic_health_calculators | Admin | BASIC_HEALTH_CALC-F02 | Page / Flow / Admin view | BASIC_HEALTH_CALC-API02 | Draft | assets/README.md |
...
- [ ] Action chính gọi đúng BASIC_HEALTH_CALC-FN01.
...
- [ ] View chỉ hiển thị đúng role và trạng thái.
- [ ] Các state bắt buộc đều có thiết kế và test.
- [ ] Action chính gọi đúng BASIC_HEALTH_CALC-FN02.
- [ ] Error message không lộ thông tin kỹ thuật hoặc dữ liệu nhạy cảm.
