...
|---|---|---|---|---|---|---|---|---|---|
| RECONCILIATION-FN01 | runReconciliation | RECONCILIATION-F01 | Use case / Service | planned:lib/app_versions/v3/features/reconciliation/application/reconciliation_fn01.dart | Admin chọn kỳ hoặc scheduled job | Command + actor context | Result/Error | Audit/event when required | Approved - DD docs complete |
| RECONCILIATION-FN02 | resolveReconciliationDiscrepancy | RECONCILIATION-F02 | Use case / Service | planned:lib/app_versions/v3/features/reconciliation/application/reconciliation_fn02.dart | Admin reviews discrepancy | Command + actor context | Result/Error | Audit/event when required | Approved - DD docs complete |
...
|---|---|---|---|
| RECONCILIATION-FN-EV01-01 | Happy path cho RECONCILIATION-FN01. | Documented | Required in implementation/test phase; not executed in this DD docs pass |
| RECONCILIATION-FN-EV01-02 | Business rule violation cho RECONCILIATION-BR01. | Documented | Required in implementation/test phase; not executed in this DD docs pass |
| RECONCILIATION-FN-EV01-03 | Permission denied theo role/scope. | Documented | Required in implementation/test phase; not executed in this DD docs pass |
| RECONCILIATION-FN-EV01-04 | Idempotency/retry nếu có ghi dữ liệu. | Documented | Required in implementation/test phase; not executed in this DD docs pass |
| RECONCILIATION-FN-EV01-05 | Audit hoặc event được tạo khi BD yêu cầu. | Documented | Required in implementation/test phase; not executed in this DD docs pass |
...
| ID | Requirement | DD docs status | Implementation evidence |
|---|---|---|---|
| RECONCILIATION-FN-EV02-01 | Happy path cho RECONCILIATION-FN02. | Documented | Required in implementation/test phase; not executed in this DD docs pass |
| RECONCILIATION-FN-EV02-02 | Business rule violation cho RECONCILIATION-BR02. | Documented | Required in implementation/test phase; not executed in this DD docs pass |
| RECONCILIATION-FN-EV02-03 | Permission denied theo role/scope. | Documented | Required in implementation/test phase; not executed in this DD docs pass |
| RECONCILIATION-FN-EV02-04 | Idempotency/retry nếu có ghi dữ liệu. | Documented | Required in implementation/test phase; not executed in this DD docs pass |
| RECONCILIATION-FN-EV02-05 | Audit hoặc event được tạo khi BD yêu cầu. | Documented | Required in implementation/test phase; not executed in this DD docs pass |
