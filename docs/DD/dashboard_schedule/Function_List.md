...
|---|---|---|---|---|---|---|---|---|---|
| DASHBOARD_SCHEDULE-FN01 | loadDashboardSchedule | DASHBOARD_SCHEDULE-F01 | Use case / Service | planned:lib/app_versions/v1/features/dashboard/application/dashboard_schedule_fn01.dart | Mở dashboard | Command + actor context | Result/Error | Audit/event when required | Draft |
| DASHBOARD_SCHEDULE-FN02 | markPlanItemProgress | DASHBOARD_SCHEDULE-F02 | Use case / Service | planned:lib/app_versions/v1/features/dashboard/application/dashboard_schedule_fn02.dart | Bấm hoàn thành hoặc bỏ qua | Command + actor context | Result/Error | Audit/event when required | Draft |
...
- [ ] Happy path cho DASHBOARD_SCHEDULE-FN01.
- [ ] Business rule violation cho DASHBOARD_SCHEDULE-BR01.
...
- [ ] Happy path cho DASHBOARD_SCHEDULE-FN02.
- [ ] Business rule violation cho DASHBOARD_SCHEDULE-BR02.
- [ ] Permission denied theo role/scope.
- [ ] Idempotency/retry nếu có ghi dữ liệu.
- [ ] Audit hoặc event được tạo khi BD yêu cầu.
