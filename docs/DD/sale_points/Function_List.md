...
|---|---|---|---|---|---|---|---|---|---|
| SALE_POINTS-FN01 | creditSalePointsForApprovedPayment | SALE_POINTS-F01 | Use case / Service | planned:lib/sale_referral/sale_points/application/sale_points_fn01.dart | payment_approved event | Command + actor context | Result/Error | Audit/event when required | Draft |
| SALE_POINTS-FN02 | requestAndReviewSalePointConversion | SALE_POINTS-F02 | Use case / Service | planned:lib/sale_referral/sale_points/application/sale_points_fn02.dart | Sale submits conversion request | Command + actor context | Result/Error | Audit/event when required | Draft |
...
- [ ] Happy path cho SALE_POINTS-FN01.
- [ ] Business rule violation cho SALE_POINTS-BR01.
...
- [ ] Happy path cho SALE_POINTS-FN02.
- [ ] Business rule violation cho SALE_POINTS-BR02.
- [ ] Permission denied theo role/scope.
- [ ] Idempotency/retry nếu có ghi dữ liệu.
- [ ] Audit hoặc event được tạo khi BD yêu cầu.
