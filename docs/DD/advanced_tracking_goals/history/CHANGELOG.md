# CHANGELOG — ADVANCED_TRACKING_GOALS / Theo dõi nâng cao & mục tiêu

## [v1.2] - 2026-06-30
### Changed
- Marked ADVANCED_TRACKING_GOALS DD docs as `Approved - DD docs complete`.
...
## [v1.0] - 2026-06-28
### Added
- Initial DD created from docs/BD/project_flow/BD_BioAI_Product_Flow_Sale_Admin_v2.0.md (BD-BIOAI-PRODUCT-FLOW-002), scope BD sections 6/M10, 16.1 AC-06, Appendix A UC-10.
- Created README, Overall, List_Features, Function_List, Views, Import_File, diagrams README, assets README, and changelog.

### Impact
- Affected module: M10 / ADVANCED_TRACKING_GOALS.
