...
## Muc tieu fix
- Dua widget test ve dung behavior hien tai cua Features Hub: tile AI hien la `Tro chuyen voi Nami` va dieu huong den AI Chat.
...
- Copy user-facing phai giu tieng Viet co dau va giong Nami.
