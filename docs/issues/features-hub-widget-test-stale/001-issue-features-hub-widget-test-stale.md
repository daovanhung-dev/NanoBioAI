...
- UI hiện tại dùng tiếng Việt và tile AI là `Trò chuyện với Nabi`.
...
- `lib/features/features_hub/presentation/pages/features_hub_page.dart:61-67` tile AI hiện là `Trò chuyện với Nabi` và `context.push(RoutePaths.aiChat)`.
...
- Nếu behavior mới đúng: cập nhật test để tap `Trò chuyện với Nabi` và assert route chat.
