Commit de xuat: test(real-device): ghi nhan case V2-M06-02

# V2-M06-02

- Trạng thái: PENDING
- Persona/tiền điều kiện: `F0` va `FQ3` tao lich
- BD/DD/AC: BD §6 M06, AC-05
- Thiết bị bắt buộc: Xiaomi 220333QPG, Android 11/API 30, 720x1650

## Kịch bản và kết quả mong đợi

Free dung dung 3 lan tao lich/thang va bi chan lan thu 4; khong goi AI, khong dem quota sai.
