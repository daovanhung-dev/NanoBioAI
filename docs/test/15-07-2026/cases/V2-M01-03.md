Commit de xuat: test(real-device): ghi nhan case V2-M01-03

# V2-M01-03

- Trạng thái: PENDING
- Persona/tiền điều kiện: `G0`
- BD/DD/AC: BD §6 M01 - consent
- Thiết bị bắt buộc: Xiaomi 220333QPG, Android 11/API 30, 720x1650

## Kịch bản và kết quả mong đợi

Tu choi dong y bat buoc; khong sinh lich dung du lieu khong duoc dong y va UX xu ly theo chinh sach.
