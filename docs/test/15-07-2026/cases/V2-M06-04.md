Commit de xuat: test(real-device): ghi nhan case V2-M06-04

# V2-M06-04

- Trạng thái: PENDING
- Persona/tiền điều kiện: `PP`
- BD/DD/AC: BD §6 M06, §8, AC-07
- Thiết bị bắt buộc: Xiaomi 220333QPG, Android 11/API 30, 720x1650

## Kịch bản và kết quả mong đợi

Payment Plus dang cho duyet khong mo entitlement Plus, ke ca khi refresh/relaunch.
