    ...
    return NamiCareScaffold(
      ...
      children: [
        const NamiCareSectionTitle(
          ...
          subtitle: 'Khi bạn sẵn sàng, Nami sẽ cùng bạn nhìn lại thay đổi của cơ thể theo cách dịu dàng nhất.',
        ),
        ...
        const NamiCareEmptyState(
          ...
          message: 'Nami chưa có đủ thông tin để nhìn lại cùng bạn. Khi sẵn sàng, mình ghi một vài chỉ số nhỏ nhé.',
        ),
      ],
    );
  }
