    ...
    return NamiCareScaffold(
      ...
      children: [
        const NamiCareEmptyState(
          ...
          message: 'Tuần này Nami chưa có đủ thông tin để tổng kết thật trọn vẹn. Mình cứ bắt đầu từ hôm nay nhé.',
        ),
        const SizedBox(height: AppSpacing.lg),
        const NamiCareSectionTitle(
          title: 'Nami sẽ nhìn lại những điều này',
          subtitle: 'Khi các góc chăm sóc có thêm ghi nhận, tổng kết tuần sẽ đầy đủ và gần với bạn hơn.',
        ),
