    ...
    return NamiCareScaffold(
      ...
      children: [
        const NamiCareSectionTitle(
          ...
          subtitle: 'Bạn chỉ cần chọn một mục tiêu vừa sức. Nami sẽ nhắc thật nhẹ, không tạo áp lực.',
        ),
        ...
        if (_selectedIndex != null) ...[
          ...
          NamiCareEmptyState(
            ...
            message: 'Mình không cần làm thật nhiều ngay lập tức. Chỉ cần quay lại từng chút, Nami sẽ cùng bạn giữ nhịp.',
          ),
        ],
      ],
    );
