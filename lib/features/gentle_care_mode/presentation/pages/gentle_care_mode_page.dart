...
import 'package:nano_app/features/features_hub/presentation/widgets/nami_care_page.dart';
...
class _GentleCareModePageState extends State<GentleCareModePage> {
  ...
  static const _suggestions = [
    _CareSuggestion(
      ...
      subtitle: 'Một ngụm nhỏ cũng là cách báo với cơ thể rằng bạn vẫn đang chăm mình.',
    ),
    _CareSuggestion(
  ...
  Widget build(BuildContext context) {
    return NamiCareScaffold(
      ...
      subtitle: 'Không sao đâu, hôm nay mình chăm bản thân nhẹ hơn một chút nhé.',
      ...
      children: [
        const NamiCareSectionTitle(
          ...
          subtitle: 'Chọn cảm giác gần nhất lúc này. Nami sẽ giúp bạn hạ mục tiêu xuống thật vừa sức.',
        ),
        ...
        if (_selectedIndex != null) ...[
          ...
          const NamiCareEmptyState(
            ...
            message: 'Mình chỉ cần không bỏ quên bản thân là được. Nami sẽ gợi ý vài việc thật nhẹ để bạn dễ chịu hơn.',
          ),
          const SizedBox(height: AppSpacing.lg),
