...
const List<HealthFeatureCatalogItem> advancedHealthFeatureCatalog = [
  ...
  HealthFeatureCatalogItem(
    ...
    comingSoonMessage: 'Nabi chỉ tóm tắt nội dung bạn đã xác nhận.',
    icon: Icons.healing_rounded,
    color: AppColors.tertiary,
    minimumAccess: HealthFeatureMinimumAccess.plus,
    previewItems: [
      'Ghi triệu chứng và mức độ',
      'Nabi tóm tắt nhật ký đã xác nhận',
  ...
  HealthFeatureCatalogItem(
    ...
    comingSoonMessage: 'Nabi chỉ hỗ trợ nhập liệu sau khi bạn xác nhận.',
    icon: Icons.science_rounded,
    color: AppColors.secondary,
    minimumAccess: HealthFeatureMinimumAccess.plus,
    previewItems: [
      'Ghi kết quả và đơn vị',
      'Nabi hỗ trợ trích xuất để bạn xác nhận',
  ...
  HealthFeatureCatalogItem(
    ...
    title: 'Xu hướng sức khỏe cùng Nabi',
    description: 'Tổng hợp số liệu đã có thành báo cáo dễ đọc.',
    comingSoonEyebrow: 'XU HƯỚNG SỨC KHỎE CÙNG NABI',
    comingSoonMessage: 'Nabi diễn đạt số liệu, không suy đoán bệnh.',
    icon: Icons.auto_graph_rounded,
    color: AppColors.tertiary,
    minimumAccess: HealthFeatureMinimumAccess.plus,
    previewItems: [
      'Tổng hợp thống kê',
      'Nabi diễn đạt báo cáo dễ đọc',
      'Xem lại xu hướng',
    ],
  ),
];
