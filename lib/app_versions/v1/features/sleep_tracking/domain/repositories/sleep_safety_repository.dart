...
abstract class SleepSafetyRepository {
  ...
  Future<List<SafetyContact>> loadContacts(String userId, {bool refreshCloud = true});
  Future<SafetyContact> saveContact({String? id, required String name, required String relationship, required String phoneE164, required int priority});
