...
abstract final class NabiAssetResolver {
  ...
  static String pathFor(NabiVisualState state) {
    return switch (state) {
      ...
      // ── onboarding ──────────────────────────────────────────
      NabiVisualState.onboardingIntro       => '$_base/onboarding/Nabi_onboarding_intro.png',
      NabiVisualState.onboardingBasicInfo   => '$_base/onboarding/Nabi_onboarding_basic_info.png',
      NabiVisualState.onboardingBodyProfile => '$_base/onboarding/Nabi_onboarding_body_profile.png',
      NabiVisualState.onboardingGoal        => '$_base/onboarding/Nabi_onboarding_goal.png',
      NabiVisualState.onboardingHealthCheck => '$_base/onboarding/Nabi_onboarding_health_check.png',
      NabiVisualState.onboardingLifestyle   => '$_base/onboarding/Nabi_onboarding_lifestyle.png',
      NabiVisualState.onboardingReview      => '$_base/onboarding/Nabi_onboarding_review.png',
      NabiVisualState.aiGeneratingPlan      => '$_base/onboarding/Nabi_ai_generating_plan.png',
      ...
      NabiVisualState.notificationReminder => '$_base/daily/Nabi_notification_reminder.png',
      ...
      NabiVisualState.chatAnswerReady  => '$_base/chat/Nabi_chat_answer_ready.png',
      ...
      NabiVisualState.chatExerciseTip  => '$_base/chat/Nabi_chat_exercise_tip.png',
      ...
      NabiVisualState.taskSkipGentle       => '$_base/progress/Nabi_task_skip_gentle.png',
      NabiVisualState.missedTaskRemind     => '$_base/progress/Nabi_missed_task_remind.png',
      NabiVisualState.lowProgressEncourage => '$_base/progress/Nabi_low_progress_encourage.png',
      ...
      NabiVisualState.milestoneBadge       => '$_base/progress/Nabi_milestone_badge.png',

      // ── engagement ──────────────────────────────────────────
      NabiVisualState.newUser           => '$_base/engagement/Nabi_new_user.png',
      NabiVisualState.freshRestart      => '$_base/engagement/Nabi_fresh_restart.png',
      ...
      NabiVisualState.occasionalUser    => '$_base/engagement/Nabi_occasional_user.png',
      ...
      // ── system ──────────────────────────────────────────────
      NabiVisualState.emptyDashboard        => '$_base/system/Nabi_empty_dashboard.png',
      ...
      NabiVisualState.notificationPermission => '$_base/system/Nabi_notification_permission.png',
      NabiVisualState.login                 => '$_base/system/Nabi_login.png',
      NabiVisualState.accountConnected      => '$_base/system/Nabi_account_connected.png',
      ...
      NabiVisualState.familyMemberJoined  => '$_base/future/Nabi_family_member_joined.png',
      NabiVisualState.familyPlan          => '$_base/future/Nabi_family_plan.png',
      NabiVisualState.familySharedProgress => '$_base/future/Nabi_family_shared_progress.png',
      NabiVisualState.referralInvite      => '$_base/future/Nabi_referral_invite.png',
      NabiVisualState.referralSuccess     => '$_base/future/Nabi_referral_success.png',
      NabiVisualState.premiumUnlocked     => '$_base/future/Nabi_premium_unlocked.png',
      NabiVisualState.salesLeaderboard    => '$_base/future/Nabi_sales_leaderboard.png',
      NabiVisualState.salesReward         => '$_base/future/Nabi_sales_reward.png',
      NabiVisualState.commissionSuccess   => '$_base/future/Nabi_commission_success.png',
    };
  }
}
