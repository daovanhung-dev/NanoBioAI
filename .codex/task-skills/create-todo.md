# Task Skill - Create todo docs

- Canonical key: create-todo
- Workflow: .codex/workflows/create-todo.md
- Generated from 1 worklog(s).

## When To Read

- Historical task type: create-todo (1)
...
- [Worklog - Create todos from issues](../../docs/worklog/2026-06-19/010-worklog-create-todos-from-issues.md) - docs/issues, docs/todo
