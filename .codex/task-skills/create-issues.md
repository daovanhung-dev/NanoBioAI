# Task Skill - Create issue docs

- Canonical key: create-issues
- Workflow: .codex/workflows/create-issues.md
- Generated from 0 worklog(s).

## When To Read

- Read this when the current request maps to create-issues; no historical worklog has used this canonical key yet.
