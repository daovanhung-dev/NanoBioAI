...
| --- | --- | --- | ---: | --- |
| coding | Coding | .codex/workflows/coding.md | 19 | [coding.md](coding.md) |
| bugfix | Direct bugfix | .codex/workflows/bugfix.md | 11 | [bugfix.md](bugfix.md) |
...
| docs-context | Context and docs update | .codex/workflows/docs-context.md | 19 | [docs-context.md](docs-context.md) |
