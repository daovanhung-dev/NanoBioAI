...
| --- | --- | --- | ---: | --- |
| coding | Coding | .codex/workflows/coding.md | 26 | [coding.md](coding.md) |
| bugfix | Direct bugfix | .codex/workflows/bugfix.md | 21 | [bugfix.md](bugfix.md) |
| fix-issues | Fix documented issue | .codex/workflows/fix-issues.md | 2 | [fix-issues.md](fix-issues.md) |
| test | Test and verification | .codex/workflows/test.md | 6 | [test.md](test.md) |
...
| docs-context | Context and docs update | .codex/workflows/docs-context.md | 25 | [docs-context.md](docs-context.md) |
