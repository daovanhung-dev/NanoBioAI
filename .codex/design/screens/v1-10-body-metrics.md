...
> Classification: **active-route** · Group: `03_dashboard_health` · Archetype: `health-form`

## 01. Purpose
Cho phép xem/nhập chỉ số cơ thể với ưu tiên rõ ràng, tránh diễn giải quá mức.

## 02. Source evidence
- Source: `lib/app_versions/v1/features/body_metrics/presentation/pages/body_metrics_page.dart`
