...
> Classification: **active-route** · Group: `06_v2_v3_access` · Archetype: `score-dashboard`

## 01. Purpose
Giải thích điểm sức khỏe, breakdown và tiến độ thói quen kèm disclaimer rõ.

## 02. Source evidence
- Source: `lib/app_versions/v2/features/health_scoring/presentation/pages/health_score_habits_page.dart`
