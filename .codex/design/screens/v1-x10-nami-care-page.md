# V1-X10 — Nami Care Page

> Baseline: `daovanhung-dev/NanoBioAI` @ `d126e8ad0c482e3eacc373f35b37f339dd37a8cb`  
> Classification: **active-route** · Group: `03_dashboard_health` · Archetype: `care-hub`

## 01. Purpose
Cung cấp một hub chăm sóc gần gũi, ưu tiên nhiệm vụ ngắn và trạng thái hiện tại.

## 02. Source evidence
- Source: `lib/app_versions/v1/features/features_hub/presentation/widgets/nami_care_page.dart`
...
## 03. Route / entry
`V1RoutePaths.namiCare` (`/nami-care`)
...
The route exposes only existing local wellness destinations: Water, Personal Goals, Quick Care, Gentle Care and Weekly Summary. Expert, booking and unapproved care capabilities remain absent.
