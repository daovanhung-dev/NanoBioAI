# V1-X06 — Weekly Summary

> Baseline: `daovanhung-dev/NanoBioAI` @ `d126e8ad0c482e3eacc373f35b37f339dd37a8cb`  
> Classification: **active-route** · Group: `03_dashboard_health` · Archetype: `summary`

## 01. Purpose
Tóm tắt tuần theo xu hướng, thành tựu và gợi ý nhỏ; tránh chấm điểm mang tính phán xét.

## 02. Source evidence
- Source: `lib/app_versions/v1/features/weekly_summary/presentation/pages/weekly_summary_page.dart`
...
## 03. Route / entry
`V1RoutePaths.weeklySummary` (`/weekly-summary`)
...
## 09. Page anatomy
Glanceable Bento hierarchy: hero → key signals → actions → details.
...
## 17. Primary action
One highlighted next action; cards remain scannable.
...
Route is active. Empty summary remains honest and is derived only from real records; it must not synthesize sample progress.

## 25. Motion
Number/progress tween only when value changes; 220–450 ms. Reduced Motion must collapse movement to opacity/static state changes while preserving causality and hierarchy.
