# V1-06 — Onboarding Journey Shell

> Baseline: `daovanhung-dev/NanoBioAI` @ `d126e8ad0c482e3eacc373f35b37f339dd37a8cb`  
> Classification: **active-route** · Group: `02_onboarding_auth` · Archetype: `stepper-shell`

## 01. Purpose
Điều phối các bước onboarding, back behavior và trạng thái lưu mà không làm người dùng quá tải.

## 02. Source evidence
- Source: `lib/app_versions/v1/features/onboarding/presentation/pages/onboarding_page.dart`
