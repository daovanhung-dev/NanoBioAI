# V1-11 — Lifestyle Schedule

> Baseline: `daovanhung-dev/NanoBioAI` @ `d126e8ad0c482e3eacc373f35b37f339dd37a8cb`  
> Classification: **active-route** · Group: `04_ai_nutrition_schedule` · Archetype: `timeline`

## 01. Purpose
Theo dõi lịch chăm sóc, trạng thái đến hạn, hoàn thành và bằng chứng theo thời gian thực.

## 02. Source evidence
- Source: `lib/app_versions/v1/features/lifestyle_schedule/presentation/pages/lifestyle_schedule_page.dart`
...
## 09. Page anatomy
Time-oriented vertical flow with date/progress anchors.
...
## 17. Primary action
Completion/skip/detail remain distinct and reversible where domain allows.
...
## 25. Motion
Emphasized container/fade-through; animate only changed item. Reduced Motion must collapse movement to opacity/static state changes while preserving causality and hierarchy.
