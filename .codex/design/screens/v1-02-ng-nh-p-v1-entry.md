# V1-02 — Đăng nhập V1 Entry

> Baseline: `daovanhung-dev/NanoBioAI` @ `d126e8ad0c482e3eacc373f35b37f339dd37a8cb`  
> Classification: **active-route** · Group: `02_onboarding_auth` · Archetype: `auth-entry`

## 01. Purpose
Đưa người dùng V1 sang luồng đăng nhập thống nhất với cảm giác tin cậy.

## 02. Source evidence
- Source: `lib/app_versions/v1/features/auth/presentation/pages/v1_auth_entry_page.dart`
