...
> Classification: **internal-step** · Group: `02_onboarding_auth` · Archetype: `welcome`

## 01. Purpose
Tạo cảm giác được đồng hành, giải thích ngắn giá trị của Nabi.

## 02. Source evidence
- Source: `lib/app_versions/v1/features/onboarding/presentation/widgets/welcome_step.dart`
