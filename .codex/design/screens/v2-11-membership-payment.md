# V2-11 — Membership Payment

> Baseline: `daovanhung-dev/NanoBioAI` @ `d126e8ad0c482e3eacc373f35b37f339dd37a8cb`  
> Classification: **active-route** · Group: `06_v2_v3_access` · Archetype: `payment`

## 01. Purpose
Tạo QR/chuyển khoản và diễn giải trạng thái duyệt; không biểu đạt thanh toán thành công trước trusted backend.

## 02. Source evidence
- Source: `lib/app_versions/v2/features/payments/presentation/pages/membership_payment_page.dart`
...
## 09. Page anatomy
Trust-first financial workspace with totals before transaction detail.
...
## 17. Primary action
Mutation requires explicit confirmation/status; no fake success.
...
## 25. Motion
Restrained 160–220 ms; no confetti for money. Reduced Motion must collapse movement to opacity/static state changes while preserving causality and hierarchy.
