...
> Classification: **active-route** · Group: `04_ai_nutrition_schedule` · Archetype: `health-dashboard`

## 01. Purpose
Tổng hợp hồ sơ dinh dưỡng và điểm vào kế hoạch ăn theo cách glanceable, không biến dữ liệu thành chẩn đoán.

## 02. Source evidence
- Source: `lib/app_versions/v1/features/nutrition/presentation/pages/nutrition_page.dart`
