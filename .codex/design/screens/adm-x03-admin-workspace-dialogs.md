# ADM-X03 — Admin Workspace Dialogs

> Baseline: `daovanhung-dev/NanoBioAI` @ `d126e8ad0c482e3eacc373f35b37f339dd37a8cb`  
> Classification: **dialog-surface** · Group: `08_admin` · Archetype: `admin-dialog`

## 01. Purpose
Xác nhận thao tác nhạy cảm, hiển thị impact và không báo success trước khi mutation hoàn tất.

## 02. Source evidence
- Source: `lib/app_versions/admin/features/admin_panel/presentation/pages/admin_workspace_dialogs.dart`
