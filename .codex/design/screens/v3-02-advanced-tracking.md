# V3-02 — Advanced Tracking

> Baseline: `daovanhung-dev/NanoBioAI` @ `d126e8ad0c482e3eacc373f35b37f339dd37a8cb`  
> Classification: **active-route** · Group: `06_v2_v3_access` · Archetype: `advanced-health`

## 01. Purpose
Trình bày tracking nâng cao theo trạng thái feature thực; tránh hứa hẹn clinical capability chưa có.

## 02. Source evidence
- Source: `lib/app_versions/v3/features/advanced_tracking/presentation/pages/advanced_tracking_page.dart`
