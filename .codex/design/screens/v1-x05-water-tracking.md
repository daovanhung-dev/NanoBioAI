# V1-X05 — Water Tracking

> Baseline: `daovanhung-dev/NanoBioAI` @ `d126e8ad0c482e3eacc373f35b37f339dd37a8cb`  
> Classification: **active-route** · Group: `03_dashboard_health` · Archetype: `tracker`

## 01. Purpose
Theo dõi nước bằng thao tác một chạm và progress trực quan nếu được expose.

## 02. Source evidence
- Source: `lib/app_versions/v1/features/water_tracking/presentation/pages/water_tracking_page.dart`
...
## 03. Route / entry
`V1RoutePaths.waterTracking` (`/water-tracking`)
...
Route is active. Disabled controls must explain the current trusted constraint; no hard-coded water recommendation or fabricated record.
