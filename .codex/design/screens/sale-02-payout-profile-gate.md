# SALE-02 — Payout Profile Gate

> Baseline: `daovanhung-dev/NanoBioAI` @ `d126e8ad0c482e3eacc373f35b37f339dd37a8cb`  
> Classification: **internal-surface** · Group: `07_sale` · Archetype: `financial-form`

## 01. Purpose
Hoàn thiện CCCD/ngân hàng trước dashboard hoặc rút tiền, copy bảo mật và validation rõ.

## 02. Source evidence
- Source: `lib/sale_referral/presentation/pages/sale_shell_page.dart` (symbol `_SalePayoutProfileGate`)
