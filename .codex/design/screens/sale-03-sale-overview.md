# SALE-03 — Sale Overview

> Baseline: `daovanhung-dev/NanoBioAI` @ `d126e8ad0c482e3eacc373f35b37f339dd37a8cb`  
> Classification: **internal-surface** · Group: `07_sale` · Archetype: `business-dashboard`

## 01. Purpose
Xem khách hàng trực tiếp, thanh toán hợp lệ, điểm giữ và điểm khả dụng trong một glance.

## 02. Source evidence
- Source: `lib/sale_referral/presentation/pages/sale_shell_page.dart` (symbol `_OverviewTab`)
