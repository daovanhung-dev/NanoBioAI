# V2-05 — Forgot Password

> Baseline: `daovanhung-dev/NanoBioAI` @ `d126e8ad0c482e3eacc373f35b37f339dd37a8cb`  
> Classification: **active-route** · Group: `06_v2_v3_access` · Archetype: `auth-form`

## 01. Purpose
Khởi tạo khôi phục mật khẩu với copy bảo mật, không xác nhận tài khoản tồn tại quá mức.

## 02. Source evidence
- Source: `lib/app_versions/v2/features/auth/presentation/pages/auth_pages.dart`
...
## 09. Page anatomy
Single-column trust flow, max content width 520–600 px.
...
## 17. Primary action
One dominant CTA; secondary route action low emphasis.
...
## 25. Motion
Short fade/size 160–220 ms; no distracting background motion. Reduced Motion must collapse movement to opacity/static state changes while preserving causality and hierarchy.
