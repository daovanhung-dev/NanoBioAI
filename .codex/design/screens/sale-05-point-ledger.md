# SALE-05 — Point Ledger

> Baseline: `daovanhung-dev/NanoBioAI` @ `d126e8ad0c482e3eacc373f35b37f339dd37a8cb`  
> Classification: **internal-surface** · Group: `07_sale` · Archetype: `ledger`

## 01. Purpose
Hiển thị từng dòng điểm gắn với thanh toán hợp lệ và trạng thái minh bạch.

## 02. Source evidence
- Source: `lib/sale_referral/presentation/pages/sale_shell_page.dart` (symbol `_PointLedgerTab`)
