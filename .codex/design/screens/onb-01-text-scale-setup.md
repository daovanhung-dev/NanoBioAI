# ONB-01 — Text Scale Setup

> Baseline: `daovanhung-dev/NanoBioAI` @ `d126e8ad0c482e3eacc373f35b37f339dd37a8cb`  
> Classification: **source-sub-surface** · Group: `02_onboarding_auth` · Archetype: `accessibility-setup`

## 01. Purpose
Chọn cỡ chữ trước hành trình để nội dung sau đó dễ đọc.

## 02. Source evidence
- Source: `lib/app_versions/v1/features/onboarding/presentation/pages/onboarding_text_scale_page.dart`
