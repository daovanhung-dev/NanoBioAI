# V1-12 — Daily Routine Preferences

> Baseline: `daovanhung-dev/NanoBioAI` @ `d126e8ad0c482e3eacc373f35b37f339dd37a8cb`  
> Classification: **active-route** · Group: `05_profile_settings` · Archetype: `preference-form`

## 01. Purpose
Cho người dùng điều chỉnh giờ thức, ngủ, ăn, tập và khoảng bận để lịch cá nhân phù hợp hơn.

## 02. Source evidence
- Source: `lib/app_versions/v1/features/daily_routine/presentation/pages/daily_routine_preferences_page.dart`
