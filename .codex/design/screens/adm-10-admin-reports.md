# ADM-10 — Admin Reports

> Baseline: `daovanhung-dev/NanoBioAI` @ `d126e8ad0c482e3eacc373f35b37f339dd37a8cb`  
> Classification: **active-route** · Group: `08_admin` · Archetype: `admin-report`

## 01. Purpose
Xem báo cáo theo thời gian/phạm vi với filter rõ và biểu đồ tiết chế.
