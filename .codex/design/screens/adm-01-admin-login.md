...
> Classification: **active-route** · Group: `08_admin` · Archetype: `admin-auth`

## 01. Purpose
Đăng nhập quản trị với độ tin cậy cao, không dùng Nabi ambient.

## 02. Source evidence
- Source: `lib/app_versions/admin/features/admin_panel/presentation/pages/admin_login_page.dart`
