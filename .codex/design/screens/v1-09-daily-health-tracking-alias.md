# V1-09 — Daily Health Tracking Alias

> Baseline: `daovanhung-dev/NanoBioAI` @ `d126e8ad0c482e3eacc373f35b37f339dd37a8cb`  
> Classification: **alias** · Group: `04_ai_nutrition_schedule` · Archetype: `alias-surface`

## 01. Purpose
Giữ route tương thích nhưng hiển thị đúng Lifestyle Schedule thay vì tạo UI song song.

## 02. Source evidence
- Source: `lib/app_versions/v1/features/daily_health_tracking/presentation/pages/daily_health_tracking_page.dart`
...
## 17. Primary action
Delegate 1:1 to canonical target surface.
...
This route is compatibility-only; do not fork UI or state. Canonical visual behavior comes from Lifestyle Schedule.

## 25. Motion
Use target surface motion only. Reduced Motion must collapse movement to opacity/static state changes while preserving causality and hierarchy.
