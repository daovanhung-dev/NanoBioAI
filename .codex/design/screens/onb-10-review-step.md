...
> Classification: **internal-step** · Group: `02_onboarding_auth` · Archetype: `review`

## 01. Purpose
Cho người dùng kiểm tra và sửa thông tin trước khi lưu/tạo kế hoạch.

## 02. Source evidence
- Source: `lib/app_versions/v1/features/onboarding/presentation/widgets/review_step.dart`
