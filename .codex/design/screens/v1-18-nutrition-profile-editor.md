# V1-18 — Nutrition Profile Editor

> Baseline: `daovanhung-dev/NanoBioAI` @ `d126e8ad0c482e3eacc373f35b37f339dd37a8cb`  
> Classification: **active-route** · Group: `04_ai_nutrition_schedule` · Archetype: `health-form`

## 01. Purpose
Thu thập thông tin dinh dưỡng có cấu trúc, hỗ trợ nhiều lựa chọn và validation dễ hiểu.

## 02. Source evidence
- Source: `lib/app_versions/v1/features/nutrition/presentation/pages/nutrition_profile_editor_page.dart`
