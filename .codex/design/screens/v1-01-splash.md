...
> Classification: **active-route** · Group: `02_onboarding_auth` · Archetype: `launch-orchestration`

## 01. Purpose
Khởi động an toàn, biểu đạt thương hiệu và chuyển người dùng sang đúng hành trình.

## 02. Source evidence
- Source: `lib/app_versions/v1/features/splash/presentation/pages/splash_page.dart`
