# V1-X09 — Personal Goals

> Baseline: `daovanhung-dev/NanoBioAI` @ `d126e8ad0c482e3eacc373f35b37f339dd37a8cb`  
> Classification: **active-route** · Group: `03_dashboard_health` · Archetype: `goal-editor`

## 01. Purpose
Cho phép rà soát mục tiêu và ưu tiên mà không tạo áp lực thành tích.

## 02. Source evidence
- Source: `lib/app_versions/v1/features/personal_goals/presentation/pages/personal_goals_page.dart`
...
## 03. Route / entry
`V1RoutePaths.personalGoals` (`/personal-goals`)
...
## 09. Page anatomy
Progressive form sections; sticky/nearby primary action on compact screens.
...
## 17. Primary action
Validation near field; avoid disabled CTA without explanation.
...
Route is active. Locked advanced goal capability must follow the trusted membership contract; basic goals stay honest to current runtime behavior.

## 25. Motion
Selection shape morph 120–180 ms; section reveal 180–240 ms. Reduced Motion must collapse movement to opacity/static state changes while preserving causality and hierarchy.
