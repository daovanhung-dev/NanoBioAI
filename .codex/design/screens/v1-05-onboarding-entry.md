# V1-05 — Onboarding Entry

> Baseline: `daovanhung-dev/NanoBioAI` @ `d126e8ad0c482e3eacc373f35b37f339dd37a8cb`  
> Classification: **active-route** · Group: `02_onboarding_auth` · Archetype: `onboarding-entry`

## 01. Purpose
Giải thích ngắn gọn giá trị onboarding và cho phép bắt đầu với ma sát thấp.

## 02. Source evidence
- Source: `lib/app_versions/v1/features/onboarding/presentation/pages/onboarding_entry_page.dart`
