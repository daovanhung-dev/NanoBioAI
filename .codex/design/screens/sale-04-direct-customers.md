# SALE-04 — Direct Customers

> Baseline: `daovanhung-dev/NanoBioAI` @ `d126e8ad0c482e3eacc373f35b37f339dd37a8cb`  
> Classification: **internal-surface** · Group: `07_sale` · Archetype: `customer-list`

## 01. Purpose
Xem chỉ khách hàng được gắn trực tiếp với cộng tác viên, ưu tiên thông tin cần thiết.

## 02. Source evidence
- Source: `lib/sale_referral/presentation/pages/sale_shell_page.dart` (symbol `_DirectCustomersTab`)
