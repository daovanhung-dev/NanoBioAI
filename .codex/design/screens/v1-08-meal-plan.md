...
> Classification: **active-route** · Group: `04_ai_nutrition_schedule` · Archetype: `plan-timeline`

## 01. Purpose
Giúp xem thực đơn theo ngày, hiểu cấu trúc bữa ăn và thao tác trên kế hoạch cá nhân.

## 02. Source evidence
- Source: `lib/app_versions/v1/features/meal_plan/presentation/pages/meal_plan_page.dart`
