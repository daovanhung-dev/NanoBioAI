# V1-X04 — Dev Database Viewer

> Baseline: `daovanhung-dev/NanoBioAI` @ `d126e8ad0c482e3eacc373f35b37f339dd37a8cb`  
> Classification: **source-only** · Group: `03_dashboard_health` · Archetype: `developer-tool`

## 01. Purpose
Công cụ debug phải tách biệt hoàn toàn khỏi trải nghiệm người dùng production.

## 02. Source evidence
- Source: `lib/app_versions/v1/features/settings/presentation/pages/dev_database_viewer_page.dart`
