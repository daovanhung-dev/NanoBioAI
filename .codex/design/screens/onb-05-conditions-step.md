# ONB-05 — Conditions Step

> Baseline: `daovanhung-dev/NanoBioAI` @ `d126e8ad0c482e3eacc373f35b37f339dd37a8cb`  
> Classification: **internal-step** · Group: `02_onboarding_auth` · Archetype: `choice-grid`

## 01. Purpose
Ghi nhận tình trạng/vấn đề sức khỏe mà không trình bày như chẩn đoán.

## 02. Source evidence
- Source: `lib/app_versions/v1/features/onboarding/presentation/widgets/conditions_step.dart`
...
## 03. Route / entry
`V1RoutePaths.onboarding (internal)`
