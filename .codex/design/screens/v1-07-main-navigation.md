# V1-07 — Main Navigation

> Baseline: `daovanhung-dev/NanoBioAI` @ `d126e8ad0c482e3eacc373f35b37f339dd37a8cb`  
> Classification: **active-route** · Group: `01_foundation_shell` · Archetype: `app-shell`

## 01. Purpose
Cung cấp 4 vùng chính: Hôm nay, Tiện ích, Góc Nabi, Của bạn với chuyển tab nhất quán.

## 02. Source evidence
- Source: `lib/app_versions/v1/features/dashboard/presentation/pages/menu_page.dart`
