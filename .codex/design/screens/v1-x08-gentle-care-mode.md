# V1-X08 — Gentle Care Mode

> Baseline: `daovanhung-dev/NanoBioAI` @ `d126e8ad0c482e3eacc373f35b37f339dd37a8cb`  
> Classification: **active-route** · Group: `03_dashboard_health` · Archetype: `calm-mode`

## 01. Purpose
Giảm cường độ nội dung/motion cho trạng thái cần chăm sóc nhẹ nhàng.

## 02. Source evidence
- Source: `lib/app_versions/v1/features/gentle_care_mode/presentation/pages/gentle_care_mode_page.dart`
...
## 03. Route / entry
`V1RoutePaths.gentleCare` (`/gentle-care`)
...
Route is active. Reduced stimulation is a presentation preference, not a clinical mode or diagnostic state.
