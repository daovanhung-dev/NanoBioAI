# SALE-06 — Conversion Tools

> Baseline: `daovanhung-dev/NanoBioAI` @ `d126e8ad0c482e3eacc373f35b37f339dd37a8cb`  
> Classification: **internal-surface** · Group: `07_sale` · Archetype: `financial-tool`

## 01. Purpose
Sao chép mã giới thiệu, yêu cầu quy đổi và xem lịch sử với validation/idempotency semantics rõ.

## 02. Source evidence
- Source: `lib/sale_referral/presentation/pages/sale_shell_page.dart` (symbol `_ConversionToolsTab`)
