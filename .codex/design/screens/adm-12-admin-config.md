...
> Classification: **active-route** · Group: `08_admin` · Archetype: `admin-config`

## 01. Purpose
Chỉnh cấu hình hệ thống với cảnh báo impact và xác nhận trước mutation.
