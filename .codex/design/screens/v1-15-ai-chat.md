...
> Classification: **active-route** · Group: `04_ai_nutrition_schedule` · Archetype: `chat`

## 01. Purpose
Cho phép hội thoại với Nabi, làm rõ trạng thái AI, lịch sử và giới hạn sử dụng mà không phơi thuật ngữ nội bộ.

## 02. Source evidence
- Source: `lib/app_versions/v1/features/ai_chat/presentation/pages/ai_chat_screen.dart`
