...
> Classification: **active-route** · Group: `04_ai_nutrition_schedule` · Archetype: `voice`

## 01. Purpose
Tạo trải nghiệm nói-nghe với Nabi, trạng thái mic/TTS rõ và có đường thoát khi quyền hoặc dịch vụ không sẵn sàng.

## 02. Source evidence
- Source: `lib/app_versions/v1/features/ai_voice/presentation/pages/ai_voice_page.dart`
...
## 09. Page anatomy
Conversation focus with persistent composer/control zone.
...
## 17. Primary action
AI state explicit: listening/thinking/speaking/error/ready.
...
## 25. Motion
State morph + waveform only while active; respect reduce motion. Reduced Motion must collapse movement to opacity/static state changes while preserving causality and hierarchy.
