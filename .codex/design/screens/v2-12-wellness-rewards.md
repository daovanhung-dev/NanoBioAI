# V2-12 — Wellness Rewards

> Baseline: `daovanhung-dev/NanoBioAI` @ `d126e8ad0c482e3eacc373f35b37f339dd37a8cb`  
> Classification: **active-route** · Group: `06_v2_v3_access` · Archetype: `rewards`

## 01. Purpose
Hiển thị điểm/phần thưởng/voucher với trạng thái đổi thưởng rõ và chống gây hiểu nhầm tài chính.

## 02. Source evidence
- Source: `lib/app_versions/v2/features/wellness_rewards/presentation/pages/wellness_rewards_page.dart`
