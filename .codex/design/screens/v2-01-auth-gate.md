...
> Classification: **gate** · Group: `06_v2_v3_access` · Archetype: `auth-gate`

## 01. Purpose
Điều phối auth/sync mà không nhấp nháy route hoặc lộ trạng thái kỹ thuật.

## 02. Source evidence
- Source: `lib/app_versions/v2/features/auth/presentation/pages/auth_gate_page.dart`
