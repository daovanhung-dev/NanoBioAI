...
> Classification: **active-route** · Group: `06_v2_v3_access` · Archetype: `sale-shell`

## 01. Purpose
Điều phối không gian cộng tác viên, trạng thái tài khoản, payout gate và 4 tab nghiệp vụ.

## 02. Source evidence
- Source: `lib/sale_referral/presentation/pages/sale_shell_page.dart`
