...
> Classification: **active-route** · Group: `08_admin` · Archetype: `admin-log`

## 01. Purpose
Đọc lịch sử thao tác theo thứ tự thời gian, search/filter và dữ liệu bất biến.
