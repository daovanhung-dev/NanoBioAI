# NanoBio Stitch Green Wellness Design - Canonical UI handoff

This directory is the canonical UI/UX handoff for the Green Wellness migration. The repository inventory baseline remains `daovanhung-dev/NanoBioAI` commit `d126e8ad0c482e3eacc373f35b37f339dd37a8cb`; route and surface classifications were refreshed from the working tree on 2026-08-08.

## Source authority

1. For the 76 Stitch references under `docs/refactor/stitch_nanobio_design_system/`, `screen.png` decides layout and visual composition; `code.html` decides typography and design-token intent.
...
**NanoBio Stitch Green Wellness** combines calm wellness presentation with Material 3 semantic hierarchy, restrained motion and contextual Nabi support. Product is NanoBio, companion is Nabi, and the care hub remains Nami Care.
...
- Green visual, dark, accessibility and adaptive QA remain open until evidence is recorded per surface.
